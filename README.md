...
Chọn năm sinh, xem mệnh ngũ hành nạp âm cùng màu và hướng theo quy ước cổ điển.

*[Read this in English](README.en.md)*

**Xem nó chạy thật:** https://nhatnguyet.org/widget/cung-menh
...
Widget cá nhân hoá duy nhất trong thư viện: người xem chọn năm sinh và thấy ngay mệnh ngũ hành nạp âm của mình. Kết quả nhớ lại ở lần ghé sau, lưu trên chính máy người xem chứ không gửi về máy chủ nào.

## Vài điều nên biết trước

- Luận giải nói về hệ thống ngũ hành, không phán về người xem. Không có câu nào đoán vận trình.
- Màu và hướng là quy ước cổ điển chứ không phải giá trị tính ra, và widget nói rõ điều đó ngay trong khung.
- Chỉ lưu năm sinh trên máy người xem, không lưu ngày tháng và không gửi đi đâu.

## Các bước

1. Dán mã nhúng vào chỗ bạn muốn, không cần cấu hình gì thêm.
2. Người xem chọn năm sinh một lần, lần sau ghé lại widget tự hiện kết quả cũ.
3. Muốn khung hẹp thì đặt data-size compact, vòng tròn màu sẽ được bỏ đi.
...
|---|---|---|
| `data-widget` | `cung-menh` | Bắt buộc |
...
```html
<div data-widget="cung-menh" data-theme="dark" data-accent="#1f6f5c" data-size="compact"></div>
<script async src="https://nhatnguyet.org/embed/w.js"></script>
```
